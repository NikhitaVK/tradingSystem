...
BACKTEST_N_SLICES = int(os.getenv("BACKTEST_N_SLICES", "3"))
BACKTEST_TRAIN_RATIO = float(os.getenv("BACKTEST_TRAIN_RATIO", "0.80"))  # 80/20 split
BACKTEST_MIN_TRADES_PER_SLICE = int(os.getenv("BACKTEST_MIN_TRADES_PER_SLICE", "10"))
...
# ── Loop 1 ───────────────────────────────────────────────────────────────────
LOOP1_MAX_ATTEMPTS = int(os.getenv("LOOP1_MAX_ATTEMPTS", "10"))
